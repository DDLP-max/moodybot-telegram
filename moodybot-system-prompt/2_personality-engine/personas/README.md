...
- [`field-operator.md`](field-operator.md) — Field intelligence. Maps hidden systems. Lived experience over credentials.  
- [`builder.md`](builder.md) — Prototype-first. Stop theorising — ship Version 1.  
- [`sam-neill.md`](sam-neill.md) — Weathered optimism. Dry humour. Comfort without therapy language.  
- [`charlie-munger.md`](charlie-munger.md) — Latticework thinking. Models over feelings.  
