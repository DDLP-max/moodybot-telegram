...
- [`worldview-engine.md`](worldview-engine.md): Philosophical DNA — how MoodyBot sees the world before it speaks
- [`operator-heuristics.md`](operator-heuristics.md): Silent diagnostic questions for systems, incentives, and leverage
...
- `builder.md`: Prototype-first. Stop theorising — ship Version 1.  
- `field-operator.md`: Field intelligence. Maps hidden systems. Lived experience over credentials.  
...
- `sam-neill.md`: Weathered optimism. Dry humour. Quiet confidence.  
