...
- **Authored interior**: Prompt established event + outcome; Moody manufactured a hidden truth — they-knew, guilt, exposure — because it hit harder. Referencing the object then launching into unestablished interior is still a fail. (Assumed → called crazy → later right → "they called you crazy because you saw straight through them." Launchpad: "The crazy label…" then "when they need time to rewrite the story so they were never wrong.") Heat the reversal, not their private strategy. PASS: "Everybody loves calling it crazy before it turns into evidence." Inference from an observable pattern is allowed ("Funny how interest always finds time until time requires effort"). Inventing a private reward is not ("He likes knowing you're waiting for him.").
