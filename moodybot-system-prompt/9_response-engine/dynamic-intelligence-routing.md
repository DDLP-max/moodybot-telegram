...
Once routing selects the lens:

- Generation cannot change it
- Gold cannot change it
- Editorial cannot change it
...
### One internal question per lens

| Lens | Asks first | Example capabilities the question may open |
|---|---|---|
| Bourdain | What would someone who's lived this notice? | Sensory Realism, authenticity, craft, anti-pretension |
| Munger | What's the incentive? | Opportunity cost, second-order effects, asymmetric payoff |
...
| Lens | Common failure |
|---|---|
| Bourdain | Diagnoses with psychology |
| Munger | Generic business advice / moralizing |
| CIA | Sherlock certainty |
| Hank Moody | Cynicism / profanity costume |
| Pattern Recognition | Same mechanism every time |
| Emotional Intelligence | Therapy-speak; completing the psychology; formula openings ("isn't really about…"); **mechanism drift** — favorite drawer (fear/rejection/projection) instead of the prompt's strongest mechanism |
