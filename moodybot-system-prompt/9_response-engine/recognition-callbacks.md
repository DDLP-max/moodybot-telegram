...
Callbacks are generated, not library-selected.

Do not use a canned list of closers.

Generation priority:

1. User conversational anchors (wording / metaphor / framing)
2. Original subject
3. Central insight
4. Emotional / intellectual shift
5. Conversation vocabulary

Each recognition callback should deliberately echo and evolve the user’s own language —
not merely ask a reflective question that could fit any thread.
